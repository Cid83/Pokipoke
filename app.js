...
// btn activity
 searchBtn.addEventListener("click",()=>{
  ...
  const fetchPokemons = async()=>{
    for(let i=25; i<= pokemon_count ;i++){
        await getPokemon(i)
    }
  }
        ...
        <div class="poke-info">
            ...
            <div class="small">
                <small class="poke-exp">
                    <i class="fa solid fa-flask"></i> <span> ${pokemon.base_experience}</span>
                </small>

                <small class="poke-weight">
                    <i class="fa solid fa-weight-scale"></i> <span> ${pokemon.weight}</span>
                </small>
            </div>
